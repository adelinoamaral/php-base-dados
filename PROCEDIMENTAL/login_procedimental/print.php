...
$pdf->Cell(100,10,'Definição do Utilizador',1,0);
...
while($row = mysqli_fetch_array($result)){
	...
	$pdf->Cell(50,8,'LApelido',1,0);
	$pdf->Cell(50,8,$row['lastname'],1,1);
	
	$pdf->Cell(50,8,'Aniversário',1,0);
	$pdf->Cell(50,8,$row['birthdate'],1,1);
	
	$pdf->Cell(50,8,'Nome de Utilizador',1,0);
	$pdf->Cell(50,8,$row['username'],1,1);
	
	$pdf->Cell(50,8,'Senha',1,0);

...
<?php 
    ...
    */
    ...
    /* 
        ...
        Não incluir $_GET['sort'] na query por motivos de segurança.
    */
    ...
    if ($result->num_rows > 0) {
        ...
        echo '<table class="table table-hover">';
            echo '<tr>
                  <td><a href="dashboard.php?sort=no">Nome</a></td>
                  <td><a href="dashboard.php?sort=ap">Apelido</a></td>
                  <td><a href="dashboard.php?sort=datareg">Data Registo</a></td>
                  <td>Ação</td>
              </tr>';
        ...
        if ($paginas > 1) {
            ...
            echo '<nav aria-label="Page navigation" class="text-center">';
                echo '<ul class="pagination">';
                    ...
                    {
                        echo '<li>';
                            echo '<a href="dashboard.php?s=' . ($inicio - $reg_por_pagina) . '&p=' . $paginas  . '&sort=' . $sort . '" aria-label="Previous">';
            ...
            for ($i = 1; $i <= $paginas; $i++) 
            {
                if ($i != $pagina_corrente) 
                {
                    ...
                    echo '<li><a href="dashboard.php?s=' . (($reg_por_pagina * ($i - 1))) . '&p=' . $paginas  . '&sort=' . $sort . '">' . $i . '</a></li>';
                } else {
            ...
            if ($pagina_corrente != $paginas) 
            {
                ...
                echo '<li>';
                    echo '<a href="dashboard.php?s=' . ($inicio + $reg_por_pagina) . '&p=' . $paginas . '&sort=' . $sort . '" aria-label="Next">';
